...
class MediaPlayerFrame(ctk.CTkFrame):
    ...
    def _build(self) -> None:
        self.media_viewer = ctk.CTkFrame(self, fg_color="black", corner_radius=0)
        self.media_viewer.pack(fill="both", expand=True)

        self._control_panel = ctk.CTkFrame(
            self, width=750, height=48, fg_color=("gray75", "gray25"), corner_radius=10
        )
        self._control_panel.pack(padx=0, pady=(10, 0), fill="x")
    ...
    def _build_video_controls(self) -> None:
        ...
        self._trim_info_frame.columnconfigure((0, 1, 2), weight=1)"""
        ...
        self._start_time_info_lbl.grid(row=0, column=0, sticky="w")
        self._trim_duration_info_lbl.grid(row=0, column=1)
        self._end_time_info_lbl.grid(row=0, column=2, sticky="e")
        ...
        self._volume_btn.grid(row=1, column=5, padx=5, pady=5)

        self._volume_popup = ctk.CTkFrame(self, corner_radius=4)
    ...
    def _show_volume_popup(self, event: Event | None = None) -> None:
        ...
        y = btn_y - self._volume_popup.winfo_reqheight() - 4

        self._volume_popup.place(x=x, y=y)
    ...
    def _hide_volume_popup(self) -> None:
        ...
        self._volume_popup.place_forget()
