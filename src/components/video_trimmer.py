...
class VideoTrimmer(ctk.CTkFrame):
  ...
  def __init__(self, master: Any, vlc_cmd: os.PathLike[str] | str, device_os: str, **kwargs: Any) -> None:
    super().__init__(master=master, **kwargs)
    self._vlc_cmd: os.PathLike[str] | str = vlc_cmd
    self._device_os: str = device_os

    self._media: vlc.Media | None = None
    self._media_file: os.PathLike[str] | str | None = None
  ...
  def load_media(self, vid_file: os.PathLike[str] | str) -> None:
  ...
  def _stop_and_load_media(self, vid_file: os.PathLike[str] | str, request: int) -> None:
  ...
  def _reset_vlc(self, reload_file: os.PathLike[str] | str | None = None) -> None:
  ...
  def _rebuild_instance(self, reload_file: os.PathLike[str] | str | None = None) -> None:
