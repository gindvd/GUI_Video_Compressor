...
class VideoTrimmer(ctk.CTkFrame):
    ...
    def _set_video_control_icons(self) -> None:
        ...
        self._play_btn_icon: ctk.CTkImage = ctk.CTkImage(
            light_image=Image.open(get_button_image_path("play_button.png")),
            dark_image=Image.open(get_button_image_path("play_button.png")),
            size=icon_size,
        )
        self._pause_btn_icon: ctk.CTkImage = ctk.CTkImage(
            light_image=Image.open(get_button_image_path("pause_button.png")),
            dark_image=Image.open(get_button_image_path("pause_button.png")),
            size=icon_size,
        )
        self._reverse_btn_icon: ctk.CTkImage = ctk.CTkImage(
            light_image=Image.open(get_button_image_path("reverse.png")),
            dark_image=Image.open(get_button_image_path("reverse.png")),
            size=icon_size,
        )
        self._forward_btn_icon: ctk.CTkImage = ctk.CTkImage(
            light_image=Image.open(get_button_image_path("forward.png")),
            dark_image=Image.open(get_button_image_path("forward.png")),
            size=icon_size,
        )
        self._mute_btn_icon: ctk.CTkImage = ctk.CTkImage(
            light_image=Image.open(get_button_image_path("muted_volume.png")),
            dark_image=Image.open(get_button_image_path("muted_volume.png")),
            size=icon_size,
        )
        self._unmute_btn_icon: ctk.CTkImage = ctk.CTkImage(
            light_image=Image.open(get_button_image_path("unmuted_volume.png")),
            dark_image=Image.open(get_button_image_path("unmuted_volume.png")),
            size=icon_size,
        )
        self._camera_btn_icon: ctk.CTkImage = ctk.CTkImage(
            light_image=Image.open(get_button_image_path("camera.png")),
    ...
    def _build_ui_widgets(self) -> None:
        ...
        self._control_panel = ctk.CTkFrame(
            self, width=750, fg_color=("gray75", "gray25"), corner_radius=10
        )
    ...
    def _build_video_controls(self) -> None:
        ...
        self._play_pause_btn: ctk.CTkButton = ctk.CTkButton(
            self._control_panel,
            width=35,
            height=35,
        ...
        self._reverse_10s_btn: ctk.CTkButton = ctk.CTkButton(
            self._control_panel,
            width=35,
            height=35,
            fg_color="transparent",
        ...
        self._forward_10s_btn: ctk.CTkButton = ctk.CTkButton(
            self._control_panel,
            width=35,
            height=35,
            fg_color="transparent",
    ...
    """
        ...
        self._trim_slider.grid(
            row=0, column=3, columnspan=9, padx=5, pady=(5, 0), sticky="ew"
        )

        self._curtime_lbl: ctk.CTkLabel = ctk.CTkLabel(
            self._control_panel, text="00:00:00.000"
        )
        self._curtime_lbl.grid(row=0, column=12, padx=5, pady=(5, 0))

        self._volume_btn: ctk.CTkButton = ctk.CTkButton(
            self._control_panel,
            width=35,
            height=35,
            fg_color="transparent",
        ...
        self._screenshot_btn.grid(
            row=0, column=14, padx=(5, 10), pady=(5, 0), sticky="nswe"
        )

        self._time_panel = ctk.CTkFrame(
            self._control_panel, fg_color=("gray75", "gray25"), corner_radius=10
        )
        self._time_panel.grid(
            row=1, column=0, columnspan=15, padx=5, pady=5, sticky="nswe"
        )
    ...
    def _build_timestamp_labels(self) -> None:
        ...
        ctk.CTkLabel(self._time_panel, text="New Duration:").grid(
            row=0, column=0, padx=(10, 5), pady=5, sticky="w"
        )

        self._current_duration_lbl: ctk.CTkLabel = ctk.CTkLabel(
            self._time_panel, text="00:00:00.000"
        )
        self._current_duration_lbl.grid(
            row=0, column=1, padx=(5, 10), pady=0, sticky="nswe"
        )

        ctk.CTkLabel(self._time_panel, text="Start Time:").grid(
            row=0, column=2, padx=(10, 5), pady=0, sticky="w"
        )

        self._start_time_lbl: ctk.CTkLabel = ctk.CTkLabel(
            self._time_panel, text="00:00:00.000"
        )
        self._start_time_lbl.grid(row=0, column=3, padx=(5, 10), pady=0, sticky="nswe")

        ctk.CTkLabel(self._time_panel, text="End Time:").grid(
            row=0, column=4, padx=(10, 5), pady=0, sticky="w"
        )

        self._end_time_lbl: ctk.CTkLabel = ctk.CTkLabel(
            self._time_panel, text="00:00:00.000"
        )
        self._end_time_lbl.grid(row=0, column=5, padx=(5, 10), pady=0, sticky="nswe")

        ctk.CTkLabel(self._time_panel, text="Duration:").grid(
            row=0, column=6, padx=(10, 5), pady=0, sticky="w"
        )

        self._duration_lbl: ctk.CTkLabel = ctk.CTkLabel(
            self._time_panel, text="00:00:00.000"
        )
        self._duration_lbl.grid(row=0, column=7, padx=5, pady=0, sticky="nswe")
