...
def get_icon() -> str | None:
  ...
  icon_abspath: str = resource_path(os.path.join("assets", "images", "icons", "thestrawhat.png"))
...
def get_ico() -> str | None:
  ...
  icon_abspath: str = resource_path(os.path.join("assets", "images", "icons", "thestrawhat.ico"))
...
def get_button_image_path(file_name: str) -> str:
  ...
  image_path: str = resource_path(os.path.join("assets", "images", "video_control_icons", file_name))
